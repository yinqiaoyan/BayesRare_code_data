...
n_mat[2, ]  = c(80,  0, 79, 15,  0, 1000, 1500, 2000)
n_mat[3, ]  = c(80, 81, 79,  0, 15, 1000, 1500, 2000)
n_mat[4, ]  = c( 0, 79, 80, 15,  0, 1000, 1500, 2000)
# patients
n_mat[5, ]  = c(81, 79,  0, 15,  0, 1000, 1500, 2000)
n_mat[6, ]  = c(81, 79,  0,  0, 15, 1000, 1500, 2000)
n_mat[7, ]  = c(81,  0, 80,  0,  0, 1000, 1500, 2000)
n_mat[8, ]  = c( 0, 79, 80, 15, 15, 1000, 1500, 2000)

#                  1    2    3    4    5    6    7    8
true_mean1   = c( 10,   2,   1,   8, -10,  10,   0,  12)
true_mean2   = c( 10,   7,   3,   0,  -3,   0,   9,   9)
true_sigmasq = c(1.2, 1.2, 1.2, 0.5, 0.5, 1.5, 1.5, 1.5)  
...
##############################################################
#####        Figure S1(b)1 Cell type annotations         #####
##############################################################
...
ggsave("../figures/figureS1b1.png", p, width = 11, height = 9, dpi = 100)




##############################################################
#####   Figure S1(b)2 Initial rare cell identification   #####
##############################################################
...
ggsave("../figures/figureS1b2.png", p, width = 12, height = 9, dpi = 100)




##############################################################
#####           Figure S1(b)3 BayesRare results          #####
##############################################################
...
ggsave("../figures/figureS1b3.png", p, width = 11, height = 9, dpi = 100)
